...
- 如果清楚地不是上述对象（例如人、宠物、风景、衣物、电子产品、家具、无关纸张），不要硬猜热量，返回 valid=false、input_kind="not_food" 和自然中文 rejection_message：“这似乎不是食品、饮料或一份菜肴，请重新拍一张食物、包装或营养成分表。”。
...
function normalizeModelOutput(raw, requestedIntakeGrams = null) {
  ...
  return {
    ...
    data: {
      ...
      riceEquivalent: {
        bowls: round(nutritionPerServing.energyKcal / RICE_KCAL_PER_BOWL, 1),
